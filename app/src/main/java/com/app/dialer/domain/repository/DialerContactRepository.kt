 ...
 *
 * This interface is distinct from the existing full-contact [com.app.dialer.domain.repository.ContactRepository]
 * used by the Contacts screen. It exposes a lighter surface focused on real-time
 * dial-pad auto-complete and reverse lookup.
 *
 * Implementations query Android's [android.provider.ContactsContract] ContentProvider
 * and the local Room contacts cache.
 */
interface DialerContactRepository {
